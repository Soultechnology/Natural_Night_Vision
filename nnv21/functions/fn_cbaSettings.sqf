...
[
    ...
    true,
    0,
	{if (NNV_SettingsInit) then {[] call NNV_fnc_MasterSwitch;};}
...
[
    ...
    false,
    0,
	{if (NNV_ModStarted) then {[] call NNV_fnc_Debug;};}
] call cba_settings_fnc_init; 
...
[
    ...
    [0, 420, 0, -1],
    0,
	{if (NNV_ModStarted) then {[] call NNV_fnc_SmallLoop;};}
] call cba_settings_fnc_init; 
...
[
	...
	[1, 80, 8, -1],
    0,
	{if (NNV_ModStarted) then {[] call NNV_fnc_LargeLoop;};}
] call cba_settings_fnc_init; 
...
[
    ...
    false,
    0,
	{if (NNV_ModStarted) then {[] call NNV_fnc_AntiCheeze;};}
] call cba_settings_fnc_init; 
